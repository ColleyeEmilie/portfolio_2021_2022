...
<head>
    ...
    <meta name="author" content="Emilie Colleye">
    <meta name="description" content="Portfolio de Emilie Colleye">
    <meta name="keywords" content=""Portfolio, Web, Designer, Emilie, Colleye, CV, projet, HEPL, Antilope, HTML, CSS, Javascript, wordpress"">
    ...
    <nav aria-labelledby="navigation" class="header__nav">
        <div class="navbar">
            <div class="container nav-container">
                ...
                <a href="<?= home_url() ?>" class="logo__link"><div class="nav__logo logo">
                            ...
                            <?php if ($link->hasSubItems()): ?>
                                <ul class="nav__subcontainer">
                                    <?php foreach ($link->subitems as $sub): ?>
                                        <li class="<?= $link->getBemClasses('nav__item') ?>">
                                            <a href="<?= $sub->url; ?>"<?= $sub->title ? 'title = "' . $sub->title . '"' : ''; ?>
